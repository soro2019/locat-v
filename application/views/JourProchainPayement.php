    ...
    <div class="col-sm-12">
    	<div class="box box-default">
          ...
          <div class="container-fluid">
    		    <h3 class="box-title">Liste des versements du prochain</h3>
          </div>
    		</div>
        <!-- /.box-header -->
        <div class="row">
              ...
              <div class="container-fluid">
                ...
                <?php //var_dump($ventes);die; ?>
          		  <table id="example1" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                      ...
                      <tbody>
                       <?php if(count($JourProchainPayement) > 0){ foreach($JourProchainPayement as $vente) {
                       ...
                       ?>
                          <tr>
                              ...
                              <td>
                                  <?php   
                                      if($vente['status']==0){echo '<span class="label label-danger">Non cloturé</span>'; }
