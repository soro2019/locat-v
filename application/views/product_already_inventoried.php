        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">Inventaire des produits du <?=$block['title']?> (Recomptage)</h3>
                </div>
                ...
                <div class="panel-footer">
                    <a class="btn btn-warning" style="margin-left: -25px;width: 130px;" href="<?=site_url('main/dashboard')?>">Retour</a>
                </div>
            </div>
