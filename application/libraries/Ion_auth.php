...
class Ion_auth
{
	...
	public function logout()
	{
		...
		//ADD PAR SORO
		$this->session->unset_userdata([$identity, 'id', 'user_id', 'email', 'old_last_login', 'last_check', 'ion_auth_session_hash', 'first_name', 'last_name', 'created_on', 'company','nblogin', 'id_sd']);
